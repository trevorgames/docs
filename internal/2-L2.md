...
- [Alchemy](https://www.alchemy.com/faucets/ethereum-sepolia) 是最大方的水龙头，每 24小时能领取多个测试网上的 0.5 ETH，且 L2 上的币可以通过桥转移至 L1 ，相当于每天能领 2.5 ETH！（不过 OP Sepolia -> Seplia 桥由于缺乏维护，提现时效非常不友好）
